...
const Blog = () => {
    return (
        <div className='bg-green-100 w-11/12 mx-auto my-10 p-10'>
            <div className='bg-purple-600 p-8 text-white mx-auto my-10 w-9/12'>
            ...
            <div className='bg-pink-400 p-8 text-white mx-auto my-10 w-9/12'>
            ...
            <div className='bg-green-500 p-8 text-white mx-auto my-10 w-9/12'>
            ...
            <div className='bg-indigo-600 p-8 text-white mx-auto my-10 w-9/12'>
